            ...
            <div class="p-6">
                ...
                <div class="mt-5">
                    <div class="text-gray-900 text-lg font-anuphan-semi-bold mb-1">
                        ข้อมูลเรือ ผ่านเข้าออกท่าเรืออุตสาหกรรมมาบตาพุด
                    </div>
                ...
                <div class="mt-5 mb-[6px]">
                    <span class="text-sm text-grayy-400 font-anuphan-medium">Gross Tonnage</span>
                    <span class="text-sm text-error-500">*</span>
                </div>
                <div class="grid grid-cols-[1fr_auto_1fr] gap-x-6 gap-y-4">
                  <InputNumber name="grossTonnageStart" placeholder="Gross Tonnage"
                     v-model="formGroup.grossTonnageStart" :decimal="3" required/>
                  <span class="mt-[6px]">-</span>
                  <InputNumber name="grossTonnageEnd" placeholder="Gross Tonnage"
                     v-model="formGroup.grossTonnageEnd" :decimal="3" required/>
               </div>
...
const options = [
    { label: "ปีงบประมาณ", value: "option-1" },
    { label: "ปีปฏิทิน", value: "option-2" },
];
...
const formSchema = z.object({
   grossTonnageStart: z.string().min(1, { message: t("required") }),
   grossTonnageEnd: z.string().min(1, { message: t("required") }),
});
